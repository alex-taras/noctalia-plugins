...
DraggableDesktopWidget {
  ...
  function modeTextColor() {
    if (keyLabelColorOverride !== "")
      return keyLabelColorOverride;
  ...
  function getKeyOnColor(keyName) {
    if (keyName === "Space")
      return keyColorLeaderOverride !== "" ? undefined : Color.mOnPrimary;
    if (keyName === "Ctrl")
      return keyColorCtrlOverride !== "" ? undefined : Color.mOnSecondary;
    if (keyName === "Shift")
      return keyColorShiftOverride !== "" ? undefined : Color.mOnTertiary;
    if (keyName === "Alt")
      return keyColorAltOverride !== "" ? undefined : Color.mOnTertiary;
